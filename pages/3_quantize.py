...
if st.button("🔧 開始量化"):
    ...
    shutil.copy(os.path.join(export_dir, "model.ncnn.param"), f"{temp_dir}/ncnn_model/model.param")
    shutil.copy(os.path.join(export_dir, "model.ncnn.bin"), f"{temp_dir}/ncnn_model/model.bin")
